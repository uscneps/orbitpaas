        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                We can add any functionality you need, all connected to the same CMS authentication system. From another website to a mobile app, internal CMS features, or external services for clients, everything can be tailored to your requirements.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Migration and management of old data, Easily import your existing   data, such as product catalogs or contacts.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Connect tools like Gmail, Excel, ChatGPT, Meta, and Notion to create fully automated workflows. This saves time, reduces manual errors, and streamlines processes like sending welcome emails or synchronizing sales data.
              </p>
            </article>
          </div>
        </div>
